...
% Title / Author Info
% ====================
\title{Beyond Reward Maximization:\\Evaluating the Diversity of Trajectories\\in RL with Temporal Vendi Score}
...
\institute{\textsuperscript{1}Universit\'{e} de Montr\'{e}al \qquad \textsuperscript{2}Mila -- Institut Qu\'{e}b\'{e}cois d'Intelligence Artificielle \qquad \textsuperscript{3}CIFAR}
\date{}
...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north east] at ([xshift=-0.0cm, yshift=-0.cm]current page.north east)
    {\includegraphics[height=9cm]{udem.png}};
\end{tikzpicture}
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Contributions}
    \LARGE
    \begin{itemize}
      \item We introduce the \textbf{Temporal Vendi Score (\metric{})}: a novel, domain-agnostic metric for \textbf{behavioral diversity} of RL agents.
...
\begin{column}{\colwidth}
  ...
  \begin{block}{Methodology: Temporal Vendi Score}
    \LARGE
    \begin{enumerate}
      \item \textbf{Sample Trajectories} from the agent via environment rollouts.
      ...
      $\mathcal{A}(\tau,\tau')$ = all valid monotonic alignments; $d$ is a symmetrize \textbf{time-to-reach} distance between states.
...
\begin{columns}[T]
  ...
  \begin{column}{0.96\paperwidth}
    ...
    \begin{block}{Procedure: Computing the Temporal Vendi Score}
      \centering
      \includegraphics[width=0.76\linewidth]{figures/method.pdf}
    \end{block}
    \endgroup
  \end{column}
  \separatorcolumn
...
\begin{columns}[t]
  ...
  \begin{column}{0.68\paperwidth}
    \begin{block}{Experiments \& Key Results}
      ...
      \centering
      \includegraphics[width=0.9\linewidth]{figures/interpretable.pdf}
      ...
      \centering
      \includegraphics[width=0.9\linewidth]{figures/key.pdf}
      ...
      \centering
      \includegraphics[width=0.9\linewidth]{figures/continuous.pdf}
